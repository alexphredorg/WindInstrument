// 
// SailboatComputer - NmeaOutputPort.cs
// 
// Created 01 - 2013
// 
// Alex Wetmore
...
namespace SailboatComputer
{
    ...
    internal class NmeaOutputPort
    {
        ...
        public void WriteWindHeadingAndVelocity(int heading, double velocity)
        {
            WriteSentence("MWV," + heading + ".0,R," + velocity.ToString("N1") + ",N,A");
        }
